...
function captureEditCancel() {
	$('.entries_list_space').on('click', '.cancelEditButton', function(event) {
		location.reload(true);
	})
}

function captureEditForm() {
	$('.entries_list_space').on('click', '.saveEditButton', function(event) {
		...
		var starCheckVal = $("#rateYo").rateYo("option", "rating"); //returns 50
